  ...
  return (
    <>
      <nav className="bg-white border-gray-200 bg-gradient-to-b  from-teal-300/60">
        ...
        {isOpen && (
          <div className="animate-fade-down animate-duration-200 md:hidden flex flex-col backdrop-filter backdrop-blur-lg bg-opacity-30 transition-all duration-1000 bg-slate-400 rounded rounded-b-md text-emerald-700 absolute w-full text-xl gap-10 space-y-5">
